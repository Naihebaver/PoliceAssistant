...
public class CameraSource {
    ...
    public boolean isGenericPic = false;
        ...
        public void onPreviewFrame(final byte[] data, final Camera camera) {
            ...
            Thread t = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    yuvImage.compressToJpeg(new Rect(0,0 , parameters.getPreviewSize().width,
                            parameters.getPreviewSize().height), 90, out);

                    byte[] bytes = out.toByteArray();
                    bitmap = BitmapFactory.decodeByteArray(bytes, 0, bytes.length);
                    Log.e("camera source ", "generated");
                    try{
                        out.flush();
                        out.close();
                    }catch (Exception e){}
