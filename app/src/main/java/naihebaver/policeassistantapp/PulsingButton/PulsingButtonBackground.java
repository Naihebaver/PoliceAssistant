package naihebaver.policeassistantapp.PulsingButton;
...
public class PulsingButtonBackground extends View {
    ...
    private void initialize() {
        ...
        solidPaint.setColor(getResources().getColor(R.color.colorRed));
        solidPaint.setAntiAlias(true);

        strokePaint = new Paint();
        strokePaint.setColor(getResources().getColor(R.color.colorRed));
